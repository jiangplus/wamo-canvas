...
// 选框组件
const SelectionFrame = ({ onMouseDown, isLocked }) => (
  <>
    {/* Visible Framing Box */}
    ...
    {/* Top */}
    <div className="absolute -top-1 left-2 right-2 h-2 cursor-ns-resize z-20" onMouseDown={(e) => onMouseDown(e, 'resize-n')} />
    {/* Bottom */}
    <div className="absolute -bottom-1 left-2 right-2 h-2 cursor-ns-resize z-20" onMouseDown={(e) => onMouseDown(e, 'resize-s')} />
    {/* Left */}
    <div className="absolute top-2 bottom-2 -left-1 w-2 cursor-ew-resize z-20" onMouseDown={(e) => onMouseDown(e, 'resize-w')} />
    {/* Right */}
    <div className="absolute top-2 bottom-2 -right-1 w-2 cursor-ew-resize z-20" onMouseDown={(e) => onMouseDown(e, 'resize-e')} />

    {/* Corners - Rotate (Rotation Shape) */}
    {/* Top Left */}
    <div className="absolute -top-3 -left-3 w-6 h-6 flex items-center justify-center cursor-alias z-30" onMouseDown={(e) => onMouseDown(e, 'rotate')}>
       <div className="w-2 h-2 bg-white border border-[#60a5fa] rounded-full" />
    </div>
    {/* Top Right */}
    <div className="absolute -top-3 -right-3 w-6 h-6 flex items-center justify-center cursor-alias z-30" onMouseDown={(e) => onMouseDown(e, 'rotate')}>
       <div className="w-2 h-2 bg-white border border-[#60a5fa] rounded-full" />
    </div>
    {/* Bottom Left */}
    <div className="absolute -bottom-3 -left-3 w-6 h-6 flex items-center justify-center cursor-alias z-30" onMouseDown={(e) => onMouseDown(e, 'rotate')}>
       <div className="w-2 h-2 bg-white border border-[#60a5fa] rounded-full" />
    </div>
    {/* Bottom Right */}
    <div className="absolute -bottom-3 -right-3 w-6 h-6 flex items-center justify-center cursor-alias z-30" onMouseDown={(e) => onMouseDown(e, 'rotate')}>
       <div className="w-2 h-2 bg-white border border-[#60a5fa] rounded-full" />
    </div>
  </>
);
